...
class TXOutput(object):
    ...
    def lock(self, address):
        hex_pub_key_hash = binascii.hexlify(quant.address_to_pubkey_hash(address))
    ...
    def deserialize(cls, data):
        ...
        pub_key_hash = data.get('pupb_key_hash', 0)
...
class TXInput(object):
    ...
    def use_key(self, pub_key_hash):
        ...
        hash = quant.hash_public_key(bin_pub_key)
